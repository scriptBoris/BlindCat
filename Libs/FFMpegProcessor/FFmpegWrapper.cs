...
public static class FFmpegWrapper
{
    ...
    /// </summary>
    public static Verbosity LogLevel { get; set; } = Verbosity.Fatal;
    ...
    public static void Open2(string executable, out Process process, out Stream input, out Stream output, string[] commands, bool showOutput = false)
    {
    ...
    /// </summary>
    /// <param name="executable">Executable name or path</param>
    /// <param name="commands">Command to run. This string will be passed as an argument to the executable</param>
    /// <param name="process">FFmpeg process</param>
    /// <param name="showOutput">Show output to terminal. Error stream will not be redirected if this is set to true.</param>
    public static (Stream input, Stream output) Open(string executable, string[] commands, out Process process, bool showOutput = false)
    {
        string res = string.Join(' ', commands);
        return Open(executable, res, out process, showOutput);
    }
    ...
    /// <param name="process">FFmpeg process</param>
    /// <param name="showOutput">Show output to terminal. Error stream will not be redirected if this is set to true.</param>
    public static Stream OpenOutput(string executable, string[] commands, out Process process, bool showOutput = false)
    {
        process = Process.Start(new ProcessStartInfo
        {
            FileName = executable,
    ...
    /// <param name="process">FFmpeg process</param>
    /// <param name="showOutput">Show output to terminal. Error stream will not be redirected if this is set to true.</param>
    public static (Stream input, Stream output) Open2(string executable, string command, out Process process, bool showOutput = false)
    {
        ...
        return (process.StandardInput.BaseStream, null);
    }
